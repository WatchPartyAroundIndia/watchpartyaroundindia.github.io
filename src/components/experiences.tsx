...
const Experiences: FC<ExperiencesProps> = () => {
  return (
    <div className="relative flex items-center justify-center text-center px-4 max-w-6xl mx-auto h-[650px] md:h-[750px]">
      {/* Arrows */}
      ...
      {/* Sticky Notes */}
      <div className="absolute top-[24%] md:top-[24%] left-[4%] rotate-[1.55deg] bg-orange-100 p-3 rounded-xl shadow w-36 md:w-48 lg:w-64 text-left text-sm lg:text-xl">
      ...
      <div className="absolute top-[20%] md:top-[18%] right-[5%] rotate-[18deg] bg-orange-100 p-3 rounded-xl shadow w-36 md:w-48 lg:w-64 text-left text-sm lg:text-xl">
        <p className="font-bold font-nunitoSans text-[#634200] italic text-xs md:text-sm lg:text-base">
      ...
      <div className="absolute bottom-[24%] md:bottom-[20%] left-[1%] rotate-[-9deg] bg-orange-100 p-3 rounded-xl shadow w-36 md:w-48 lg:w-64 text-left text-sm lg:text-xl">
        <p className="font-bold font-nunitoSans text-[#634200] italic text-xs md:text-sm lg:text-base">
      ...
      <div className="absolute bottom-[20%] md:bottom-[15%] right-[5%] rotate-[18deg] bg-orange-100 p-3 rounded-xl shadow w-36 md:w-48 lg:w-64 text-left text-sm lg:text-xl">
        <p className="font-bold font-nunitoSans text-[#634200] italic text-xs md:text-sm lg:text-base">
